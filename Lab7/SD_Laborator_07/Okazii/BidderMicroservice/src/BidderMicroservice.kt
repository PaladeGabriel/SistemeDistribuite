...
class BidderMicroservice {
    ...
    init {
        try {
            ...
            // fiecare mesaj primit reprezinta un element al fluxului de date reactiv->in momentul in care pe socket se primeste un mesaj observabilul il va
            //transmite in flux unde va fi vazut de subscriberi
