...
// ID-ul locaţiei nu trebuie codificat, deoarece este numeric
        val forecastDataURL =
            URL("https://wttr.in/$locationId?format=j1")
...
// parsare obiect JSON primit
        ...
        val weatherDataObject =
            responseRootObject.getJSONArray("current_condition").getJSONObject(0)
// construire şi returnare obiect POJO care încapsulează datele meteo
        return WeatherForecastData(
            ...
            temperatureCelsius = weatherDataObject.getString("temp_C"),
            temperatureFahrenheit = weatherDataObject.getString("temp_F"),
